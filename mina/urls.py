...
urlpatterns = [
    ...
    url(r'^home/$', views.book_meeting, name='book_meeting'),
    url(r'^outline/$', views.show_outline, name='show_outline'),
    url(r'^outline/edit/$', views.edit_outline_title, name='edit_outline_title'),
